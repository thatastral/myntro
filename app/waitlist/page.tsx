    ...
    >
      ...
      <main className="relative flex flex-1 flex-col items-center justify-center px-4 py-12 text-center">
        <div className="w-full max-w-[500px]">
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center" style={{ paddingTop: '19%' }}>
                ...
                >
                  <span style={{
                    ...
                    <span style={{ opacity: 0.38 }}>myntro.xyz/</span>
                    <span style={{ fontWeight: 700 }}>{username}</span>
                  </span>

                  {/* Squircle badge — exact paths + gradient from Card.svg */}
              ...
              <div
                ...
                style={{
                  ...
                  animation: 'cardGlaze 2.2s ease-in-out 0.7s forwards',
                  opacity: 0,
                }}
              />
            </div>
          ...
          <p className="mb-8 text-[15px] leading-relaxed text-[#909090]">
