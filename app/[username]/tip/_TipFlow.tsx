...
import { Copy, Check, CircleNotch, Warning, ArrowUpRight } from '@phosphor-icons/react'
import {
  ConnectionProvider,
  WalletProvider,
  useWallet,
...
function TipSend({ ownerName: _ownerName, walletAddress, username, onDone }: TipSendProps) {
    ...
    return (
      <div className="flex flex-col px-5 py-6">
        ...
        <div className="mb-3 flex items-center gap-3">
          ...
          <span className="text-[10px] font-semibold uppercase tracking-[0.12em] text-[#C8C8C8]">Receipt</span>
          <div className="h-px flex-1 bg-[#EBEBEB]" />
        </div>
...
export function TipFlow({ ownerName, walletAddress, username, onDone }: TipFlowProps) {
